    ...
    <>
      ...
      <motion.button
        ...
        className={cn(
          ...
          'bg-night-800/80 border border-white/20 backdrop-blur-md',
          'text-moon-100/60 hover:text-white hover:bg-night-700/80',
          ...
          <>
            ...
            <motion.div
              ...
              className={cn(
                ...
                'bg-night-900 border-2 border-white/20',
            ...
            >
              ...
              <p className="text-moon-100/60 text-sm mb-6">
              ...
              <div className="flex gap-3">
                <motion.button
                  ...
                  className={cn(
                    ...
                    'bg-night-800 border border-white/10 text-white',
                ...
                <motion.button
                  ...
                  className={cn(
                    'flex-1 px-4 py-3 rounded-xl font-medium',
                    'bg-blood-500 border-2 border-white/20 text-white',
                    'hover:bg-blood-500 transition-colors',
