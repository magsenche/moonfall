...
| `narration` | Rideau de narration (GET /narration) : un narrateur à personnalité attitré par partie (Corbeau / Commère / Aubergiste, stable du début à la fin), nuit 1 = endormissement seul, le jour annonce la victime et son rôle, le conseil ouvre en une ligne, la nuit suivante rappelle le verdict du bûcher ET le narrateur le commente (coupable vs bavure) |
